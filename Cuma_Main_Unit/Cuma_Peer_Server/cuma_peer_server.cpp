#include "cuma_peer_server.h"

int Cuma_Peer_Server::f_upload_file_frag_from_unit(QJsonObject o)
{
    try
    {
...
int Cuma_Peer_Server::f_reply_upload_file_frag_to_unit(const QJsonObject o)
{
    try
    {
        //유닛의 목적지가 어디인지
...
int Cuma_Peer_Server::f_download_file_frag_from_unit(QJsonObject o)
{
    try
    {
        //가지고 온 파일을 저장함
...
int Cuma_Peer_Server::f_reply_download_file_frag_to_unit(QJsonObject o)
{
...
int Cuma_Peer_Server::f_check_file_frag_to_unit(QJsonObject o)
{
...
int Cuma_Peer_Server::f_reply_check_file_frag_to_unit(const QJsonObject o)
{
    try{
...
int Cuma_Peer_Server::f_over_bypass(QJsonObject o)
{
...
int Cuma_Peer_Server::f_reply_over_bypass_limit(QJsonObject o)
{
