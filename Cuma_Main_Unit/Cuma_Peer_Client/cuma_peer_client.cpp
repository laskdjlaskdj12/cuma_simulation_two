#include "cuma_peer_client.h"

int Cuma_Peer_Client::mf_command_set_file_name(QString f_name)
{
    m_File->set_File_Name(f_name);
    return 0;
}

int Cuma_Peer_Client::mf_command_ping_test()
{
    try{
...
int Cuma_Peer_Client::mf_command_spread_test()
{
    try{
...
int Cuma_Peer_Client::mf_command_req_file_test()
{
...
int Cuma_Peer_Client::mf_command_trace_pass_test()
{
...
void Cuma_Peer_Client::mf_command_set_unit_bypass_count(uint32_t count)
{
    //유닛의 바이패스 카운트를 설정함
